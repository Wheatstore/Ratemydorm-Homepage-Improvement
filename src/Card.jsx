...
function UniversityCard({ name, numReviews, img, isVisible }) {
  return (
    ...
    <>
        <div className="card-feature-container">
            <div className="card-title">
                <h1 className='card-heading'>Explore our top schools</h1>
                <h3>Look at some of the reviews for our top schools and universities</h3>
            </div>
